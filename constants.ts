...
export const CHOPIN_EXERCISES: Exercise[] = [
  ...
  {
    id: 'a-major-scale-rh',
    title: 'A Major Scale (RH)',
    description: 'Three sharps (F#, C#, G#) give the hand a natural arch on the black keys. One of the easier sharp keys because the black keys fall under the longest fingers.',
    category: ExerciseCategory.Technical,
    type: ExerciseType.Scale,
    difficulty: Difficulty.Beginner,
    key: 'A Major',
    ...
    tips: [
      'Focus on the three sharps giving the hand a natural arch on the black keys.',
      'Thumb passes under after C#4. The black key height helps the thumb slide through cleanly.',
    ],
  },
  {
    id: 'ab-major-scale-rh',
    title: 'Ab Major Scale (RH)',
    description: 'Four flats (Ab, Bb, Db, Eb). The hand rides high on the black keys with two thumb passes creating a rolling-hills feel across the octave.',
    category: ExerciseCategory.Technical,
    type: ExerciseType.Scale,
    difficulty: Difficulty.Intermediate,
    key: 'Ab Major',
    hand: 'right' as Hand,
    notes: ['Ab3', 'Bb3', 'C4', 'Db4', 'Eb4', 'F4', 'G4', 'Ab4'],
    fingerings: [
      { note: 'Ab3', finger: 2, hand: 'right' },
      { note: 'Bb3', finger: 3, hand: 'right' },
      { note: 'C4', finger: 1, hand: 'right' },
      { note: 'Db4', finger: 2, hand: 'right' },
      { note: 'Eb4', finger: 3, hand: 'right' },
      { note: 'F4', finger: 1, hand: 'right' },
    ...
    tips: [
      'Starts on finger 2 like Bb major. The hand rides high on the black keys.',
      'Two thumb passes make this scale feel like rolling hills. Keep the wrist fluid through each pass.',
    ],
  },
  {
    id: 'eb-major-scale-rh',
    title: 'Eb Major Scale (RH)',
    description: 'Three flats (Bb, Eb, Ab) create the warm, velvet sound Chopin loved. His Nocturne Op.9 No.2 lives in this key.',
    category: ExerciseCategory.Technical,
    type: ExerciseType.Scale,
    difficulty: Difficulty.Intermediate,
    key: 'Eb Major',
    ...
    fingerings: [
      ...
      { note: 'C5', finger: 1, hand: 'right' },
      { note: 'D5', finger: 2, hand: 'right' },
      { note: 'Eb5', finger: 3, hand: 'right' },
    ],
    tips: [
      'Chopin\'s Nocturne Op.9 No.2 lives in this key. The three flats create the warm, velvet sound he loved.',
      'Thumb tucks after Eb4, then again after Bb4. Keep transitions seamless.',
    ],
  },
  {
    id: 'd-minor-harmonic-rh',
    title: 'D Minor Harmonic Scale (RH)',
    description: 'One flat (Bb) with a raised 7th (C#). The augmented second between Bb and C# is haunting — the sound of Baroque drama. The key of Mozart\'s Requiem and Beethoven\'s Ninth.',
    category: ExerciseCategory.Technical,
    type: ExerciseType.Scale,
    difficulty: Difficulty.Intermediate,
    key: 'D Minor',
    hand: 'right' as Hand,
    notes: ['D4', 'E4', 'F4', 'G4', 'A4', 'Bb4', 'C#5', 'D5'],
    fingerings: [
      { note: 'D4', finger: 1, hand: 'right' },
      { note: 'E4', finger: 2, hand: 'right' },
      { note: 'F4', finger: 3, hand: 'right' },
      { note: 'G4', finger: 1, hand: 'right' },
      { note: 'A4', finger: 2, hand: 'right' },
      { note: 'Bb4', finger: 3, hand: 'right' },
      { note: 'C#5', finger: 4, hand: 'right' },
      { note: 'D5', finger: 5, hand: 'right' },
    ],
    tips: [
      'The augmented second between Bb and C# is haunting — the sound of Baroque drama.',
      'This is the key of Mozart\'s Requiem and Beethoven\'s Ninth. Let the raised 7th pull toward D.',
    ],
  },
  {
    id: 'g-minor-harmonic-rh',
    title: 'G Minor Harmonic Scale (RH)',
    description: 'Two flats (Bb, Eb) with a raised 7th (F#). The pull from F# to G is the strongest resolution in music. Chopin\'s Ballade No. 1 begins in this key.',
    category: ExerciseCategory.Technical,
    type: ExerciseType.Scale,
    difficulty: Difficulty.Intermediate,
    key: 'G Minor',
    hand: 'right' as Hand,
    notes: ['G4', 'A4', 'Bb4', 'C5', 'D5', 'Eb5', 'F#5', 'G5'],
    fingerings: [
      { note: 'G4', finger: 1, hand: 'right' },
      { note: 'A4', finger: 2, hand: 'right' },
      { note: 'Bb4', finger: 3, hand: 'right' },
      ...
      { note: 'D5', finger: 2, hand: 'right' },
      { note: 'Eb5', finger: 3, hand: 'right' },
      { note: 'F#5', finger: 4, hand: 'right' },
      { note: 'G5', finger: 5, hand: 'right' },
    ],
    tips: [
      'Two flats plus a raised 7th (F#). The pull from F# to G is the strongest resolution in music.',
      'Chopin\'s Ballade No. 1 begins in this key. Feel the drama in the augmented second between Eb and F#.',
    ],
  },
  {
    id: 'c-minor-harmonic-rh',
    title: 'C Minor Harmonic Scale (RH)',
    description: 'Three flats (Bb, Eb, Ab) with a raised 7th (B natural). Beethoven\'s key of struggle — the Fifth Symphony, Pathetique Sonata. The half-step pull from B to C demands resolution.',
    category: ExerciseCategory.Technical,
    type: ExerciseType.Scale,
    difficulty: Difficulty.Intermediate,
    key: 'C Minor',
    ...
    tips: [
      'Beethoven\'s key of struggle — the Fifth Symphony, Pathetique Sonata.',
      'The raised B natural creates a half-step pull to C that demands resolution. Three flats give the hand plenty of black-key contact.',
    ],
  },
  {
    id: 'b-minor-harmonic-rh',
    title: 'B Minor Harmonic Scale (RH)',
    description: 'Two sharps (F#, C#) with a raised 7th (A#). The relative minor of D major. The raised A# sits right next to B — the tightest possible resolution.',
    category: ExerciseCategory.Technical,
    type: ExerciseType.Scale,
    difficulty: Difficulty.Intermediate,
    key: 'B Minor',
    ...
    fingerings: [
      ...
      { note: 'F#4', finger: 2, hand: 'right' },
      { note: 'G4', finger: 3, hand: 'right' },
      { note: 'A#4', finger: 4, hand: 'right' },
      { note: 'B4', finger: 5, hand: 'right' },
    ],
    tips: [
      'The relative minor of D major. The raised 7th (A#) sits right next to B — the tightest possible resolution.',
      'Chopin used this key for deeply introspective work. Let the A# lean into B with quiet intensity.',
    ],
  },
